 ...
 * @return  uint16_t    returns a 16 bit unsigned integer with bits [15:8] as the 'high' byte,and the bits [7:4]
 * bits as the 'low' byte. High byte is the integer value with a -64 celsius offset Low byte is [7:4] with 0.0625
 * celsius per count. Temp is the sum of the high and low byte.
 */
