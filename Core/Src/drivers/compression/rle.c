...
static void _RLE_WriteRep(unsigned char *out, unsigned int *outpos, unsigned char marker, unsigned char symbol,
                          unsigned int count) {
    unsigned int i, idx;
...
static void _RLE_WriteNonRep(unsigned char *out, unsigned int *outpos, unsigned char marker,
